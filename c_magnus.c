...
int c_magnus3w(unsigned ndim, const double *x, void *fdata, unsigned fdim, double *fval){
  ...
  double f1[2],f2[2],f2p[2],f3[2],f3p[2],f4[2],f5[2],f5p[2],f6[2],f6p[2];
  ...
  fval[0]=tmp1*(f1[0]*f2[0]*f3[0] - f1[1]*f2[1]*f3[0] + f1[1]*f2[0]*f3[1] + 
		...
		f1[1]*f2p[0]*f3p[1] - f1[0]*f2p[1]*f3p[1] + f4[0]*f5[0]*f6[0] - 
		f4[1]*f5[1]*f6[0] + f4[1]*f5[0]*f6[1] + f4[0]*f5[1]*f6[1] - 
		f4[0]*f5p[0]*f6p[0] + f4[1]*f5p[1]*f6p[0] - f4[1]*f5p[0]*f6p[1] - 
		f4[0]*f5p[1]*f6p[1]);
  fval[1]=tmp1*(f1[1]*f2[0]*f3[0] + f1[0]*f2[1]*f3[0] - 
		f1[0]*f2[0]*f3[1] + f1[1]*f2[1]*f3[1] - f1[1]*f2p[0]*f3p[0] - 
		f1[0]*f2p[1]*f3p[0] + f1[0]*f2p[0]*f3p[1] - f1[1]*f2p[1]*f3p[1] + 
		f4[1]*f5[0]*f6[0] + f4[0]*f5[1]*f6[0] - f4[0]*f5[0]*f6[1] + 
		f4[1]*f5[1]*f6[1] - f4[1]*f5p[0]*f6p[0] - f4[0]*f5p[1]*f6p[0] + 
		f4[0]*f5p[0]*f6p[1] - f4[1]*f5p[1]*f6p[1]);
  return 0;
}
